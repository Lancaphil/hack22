...
function htmljs_Chat_Init( holder )
{
    ...
    var html =  "<div class=\"holder-html-chat\" >"
		  ...
		  + "<input type=\"text\" id=\"WebChatNameID\" class=\"html-chat-js-name\"  placeholder=\"enter login\" >"
	          + "<textarea id = \"WebChatTextID\" placeholder = \"enter text\" class=\"html-chat-js-input\" ></textarea>"

                  + "<div class=\"html-chat-js-button-holder\">"
                  +    "<input type=\"button\"  onclick=\"web_send_msg();\" value=\"Send\" >"
                  +    " <div class=\"html-chat-js-answer\"  ><a href=\"https://comet-server.com\" id=\"answer\" target='__blank' >comet-server.com</a></div>"
                  + "</div>"
             +  "</div>";
    $(holder).html(html);
